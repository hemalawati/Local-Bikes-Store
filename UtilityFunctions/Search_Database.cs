...
namespace  Infrastructure
{
    public partial class Search_Database : Form0 
    {
      ...
      //  IdentityObject ident;
        ...
        //private void button_DisplayFrom_CSV_Click(object sender, EventArgs e)
        //{
        //    DataTable dTable = new DataTable();
        //    if (comboBox_Query.SelectedIndex < 0)
        //           { MessageBox.Show("you must select an item from list"); return; }
        //    string _tableName = comboBox_Query.SelectedItem.ToString();
            
        //    dTable = Utilities.DataBaseUtility.GetTable("select * from " + _tableName );
