...
namespace Utilities.Processes
{
    public partial class DisplayProcess : HAWK_Template_2  
    {
      //  List<String> _productNames;
        ...
        {
            DataTable dtable = Utilities.DataBaseUtility.GetTable("select * from processSteps where procID = " + processID);
            ...
            switch (pType)
            {
                ...
                case 12:
                 //   Deliveries.DisplayDelivery disp12 = new Deliveries.DisplayDelivery(base.ident, pStr4);  disp12.Show();
                    Utilities.Documents.DisplaySelectedObject disp12 = new Utilities.Documents.DisplaySelectedObject(base.ident,"GenDocs",pStr2,pStr4 );  disp12.Show();
                    break;
                case 13:
                   ...
                   //  Deliveries.DisplayDelivery disp13 = new Deliveries.DisplayDelivery(base.ident, pStr4);  disp13.Show();
                       Utilities.Documents.DisplaySelectedObject disp13 = new Utilities.Documents.DisplaySelectedObject(base.ident,"GenDocs",pStr2,pStr4 );  disp13.Show();
                 break;
                case 14:
                case 15:
                ...
                case 21:
                  //  Invoices.SalesOrderDisplay disp21 = new Invoices.SalesOrderDisplay(pStr4, base.ident);  disp21.Show();
                    Utilities.Documents.DisplaySelectedObject disp21 = new Utilities.Documents.DisplaySelectedObject(base.ident,"genDocs",pStr2,pStr4 );  disp21.Show();
                    break;
                case 22:
                    Utilities.Documents.DisplaySelectedObject disp22 = new Utilities.Documents.DisplaySelectedObject(base.ident, "GenDocs", pStr2,pStr4 ); disp22.Show();
                    break;
                case 23:
                 //   Invoices.InvoiceDisplay disp23 = new Invoices.InvoiceDisplay(pStr4);  disp23.Show();
                    Utilities.Documents.DisplaySelectedObject disp23 = new Utilities.Documents.DisplaySelectedObject(base.ident,"GenDocs", pStr2,pStr4 ); disp23.Show();
                    break;
                case 24:
                case 25:
                case 26:
