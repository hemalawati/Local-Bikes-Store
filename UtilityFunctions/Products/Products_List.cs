...
namespace Utilities
{
    public partial class Products_List : Products_Template 
    {
        ...
        {
            DisplayProduct app2 = new DisplayProduct(ident );
            app2.Show();
        }

        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DisplayProduct pds = new DisplayProduct(ident, dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString());
            pds.Show();
        }
